...
import { reminderAccomplished, type RootState } from "../redux/mainReducer";
...
const Dashboard = () => {
  ...
  const healthTip = useSelector((store: RootState) => store.root.healthTip);
  ...
  const reminders = patientDashboard.reminders;
                      ...
                      <ListItem sx={{ px: 0 }}>
                        ...
                        <Tooltip title="Complete Reminder">
                          <IconButton>
                            <Cancel
                              onClick={() =>
                                dispatch(reminderAccomplished(reminder.id))
                              }
                            />
                          </IconButton>
                        </Tooltip>
